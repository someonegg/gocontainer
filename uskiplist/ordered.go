...
func (l *ListO[K, E, PE]) Iterate(iterator Iterator[E]) {
	var cur, relay *E
...
//	The current element can be deleted in Iterator.
//	It will stop whenever the iterator returns false.
func (l *ListO[K, E, PE]) IterateFrom(pivot K, iterator Iterator[E]) {
	var cur *E
...
func (l *ListO[K, E, PE]) iterate(cur, relay *E, iterator Iterator[E]) {
	for {
		for cur != nil {
			save := cur
